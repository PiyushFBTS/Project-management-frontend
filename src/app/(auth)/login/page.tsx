...
import { Loader2, ShieldCheck, BarChart3, Users, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-linear-to-br from-indigo-600 via-indigo-700 to-violet-800 p-12 text-white">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white shadow-md overflow-hidden">
            ...
            <img src="/ITSM_LOGO.png" alt="FlamX logo" className="h-full w-full object-contain p-1" />
          </div>
          <div>
            <p className="font-bold text-lg leading-none tracking-wide">FlamX</p>
          </div>
        </div>
      ...
      <div className="flex flex-1 items-center justify-center bg-background px-8">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="flex items-center gap-3 lg:hidden">
            ...
            <div>
              <p className="font-bold leading-none tracking-wide">FlamX</p>
